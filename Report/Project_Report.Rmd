...
# Research Questions:
 1. How did the frequency of extreme cold days changed in the past 8 years in Texas? How does this correlates with energy load and electricity price?
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "This graph shows the number of days below freezing temperature (0 degree celsius) in Texas.", fig.align='center'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "This graph shows the monthly energy load from year 2016 to 2023 in Texas.", fig.align='center'}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "This graph shows the average monthly electricity price (cent/kwh) from year 2016 to 2023 in Texas.", fig.align='center'}
...
## Question 1: How did the frequency of extreme cold days changed in the past 8 years in Texas? How does this correlates with energy load and electricity price?

### Frequency of extreme cold days:

We used linear models analysis to find how frequency of extremely cold days impacts energy load and electricity price. 
The analysis shows if the frequency of extreme cold days impacts energy load and electricity price or not. The report first analyzed the cold day frequency and energy load. 

```{r table1, echo= FALSE}
# This following table is Hypothesis for the linear regression test for cold days impacts on monthly load, this cell is to help references for the list of tables
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "This graph shows the linear regression line between the Energy Load and # of extremely cold days (<0 degree Celsius).", fig.align='center'}
...
The report then analyzed the cold day frequency and electricity price and found that there is no strong evidence that cold day frequency has a significant effect on electricity price.
The report then analyzed the impact of energy load on electricity price.
...
```{r echo=FALSE, fig.cap = "This shows the visualization of the Time Series Analysis of the daily energy load from 2016 to 2023 in Texas", fig.align='center'}
...
```{r echo=FALSE, fig.cap = "This graph shows the visualization of the Time Series Analysis of the average daily energy load from 2016 to 2023 in Texas", fig.align='center'}
...
For electricity price, we also did time series analysis and seasonal Mann Kendall test; however, since electricity price is influenced by multiple factors aside from seasonality, such as market dynamics and policies, we also run a normal Mann Kendall test on de-trended electricity data.

```{r echo=FALSE, fig.cap = "This graph shows the visualization of the Time Series Analysis of the average daily monthly electricity price from 2016 to 2023 in Texas", fig.align='center'}
...
As shown in the table, both test results shows that electricity price has significantly increased in the past 8 years.
...
```{r fig.cap= "Arima Analysis Check Residuals for Prediction of Energy Load in 2024 and 2025", fig.align='center', echo=FALSE}
...
```
```{r fig.cap= "Forcasted Results of the Prediction of Energy Load in 2024 and 2025", fig.align='center', echo=FALSE}
# Forecast
