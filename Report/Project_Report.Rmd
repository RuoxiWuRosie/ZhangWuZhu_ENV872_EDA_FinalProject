...
# Research Questions:
 1. How does the frequency of extreme cold days correlates with energy load and electricity price in Texas?
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "Fig 2. Averaged daily energy load from year 2016 to 2023 in Texas by month.", fig.align='center'}
...
## Question 1: How does the frequency of extreme cold days correlates with energy load and electricity price?
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "Fig. Linear regression between the Energy Load and # of extremely cold days (<0 degree Celsius).", fig.align='center'}
...
```{r echo=FALSE, fig.cap = "Fig 5. Visualization of Time Series Analysis of the daily energy load from 2016 to 2023 in Texas. Trend = data - seasonal - reminder ", fig.align='center'}
...
```{r echo=FALSE, fig.cap = "Fig 6. Visualization of Time Series Analysis of the averaged daily energy load from 2016 to 2023 in Texas by month", fig.align='center'}
...
```{r echo=FALSE, fig.cap = "Fig 7. Visualization of Time Series Analysis of the averaged monthly electricity price from 2016 to 2023 in Texas", fig.align='center'}
...
Table 5. Results of Seasonal Mann Kendall and Mann Kendall tests with detrended data.
```{r table5, echo=FALSE}
# Print the results
