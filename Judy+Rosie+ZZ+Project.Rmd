...
EnergyDemand_Daily <- EnergyDemand_Daily %>%
  select(Date, ERCOT)

sum(is.na(EnergyDemand_Daily))
EnergyDemand_Daily <- EnergyDemand_Daily %>% filter(!is.na(Date))  # Remove rows with NA

EnergyDemand_Daily <- EnergyDemand_Daily %>% filter(!is.na(ERCOT))
